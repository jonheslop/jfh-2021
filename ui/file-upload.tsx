...
const FileUpload = () => {
  ...
  const preview = (file: File) => {
    ...
    return <img src={url} alt="Upload preview" />;
  };
      ...
      {file !== undefined && (
        <div className="pt-4 grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p>
              <span className="text-gray-500">Width:</span> {width}px
            </p>
            <p>
              <span className="text-gray-500">Height:</span> {height}px
            </p>
            <p>

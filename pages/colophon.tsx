    ...
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="flex-1 p-16 pb-0 w-full">
        <main className="grid grid-cols-1 md:grid-cols-page-layout auto-rows-min items-start gap-16 relative">
          ...
          <h2 className="md:col-start-2 text-4xl md:text-2xl lg:text-4xl font-medium md:sticky top-16">Colophon</h2>
          <article className="space-y-4 mt-3">
            ...
            <p className="font-medium text-xl md:text-lg lg:text-xl leading-normal">Styled with <Link href="https://tailwindcss.com/"><a className="underline hover:text-green-600">Tailwind CSS</a></Link>.</p>
            ...
            <p className="font-medium text-xl md:text-lg lg:text-xl leading-normal">Glued together with <Link href="https://github.com/jonheslop/jfh-2021"><a className="underline hover:text-green-600">javascript by me</a></Link>.</p>
          </article>
        </main>
      </div>
